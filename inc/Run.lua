...
hidar0 = Token:match("(%d+)")
our_id = tonumber(hidar0)
Apihidar0 = redis:get(hidar0..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(hidar0..":UserNameBot:")
SUDO_ID = tonumber(redis:get(hidar0..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(hidar0..'username:'..SUDO_ID).username
version = redis:get(hidar0..":VERSION")
DataCenter = redis:get(hidar0..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..hidar0..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(hidar0..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(hidar0..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(hidar0..'group:add'..msg.chat_id_) then 
...
and redis:get(hidar0.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(hidar0..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(hidar0..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(hidar0..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



print(hidar0..":IdsMsgsCleaner:"..msg.chat_id_)
local Cleaner = redis:smembers(hidar0..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(hidar0..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(hidar0..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(hidar0..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 
...
msg.TheRankCmd = redis:get(hidar0..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(hidar0..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(hidar0..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hidar0..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(hidar0..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(hidar0..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hidar0..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(hidar0..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(hidar0..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hidar0..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(hidar0..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(hidar0..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hidar0..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(hidar0..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(hidar0..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hidar0..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(hidar0..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(hidar0..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(hidar0..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(hidar0..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(hidar0..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(hidar0..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(hidar0..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(hidar0..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(hidar0..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(hidar0.."lock_Add"..msg.chat_id_) then
...
if redis:get(hidar0.."lock_check"..msg.chat_id_) and not redis:get(hidar0..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(hidar0..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(hidar0..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(hidar0..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.hidar0 then 
if msg.text and ScriptFile.ihidar0 then
Xhidar0 = ScriptFile.hidar0
local list = redis:hgetall(hidar0..":AwamerBotArray:"..msg.chat_id_)
for hidar02,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(hidar02) then 
local amrr = {Text:match(hidar02)}
local AmrOld = redis:hgetall(hidar0..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.ihidar0(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(hidar0) then -- Check Commands To admin
GetMsg = ScriptFile.ihidar0(msg,{Text:match(hidar0)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",hidar0.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dhidar0 then
if ScriptFile.dhidar0(msg) == false then
return false
end
...
if Plug.hidar0 then 
if msg.text and Plug.ihidar0 then
for k, hidar0 in pairs(Plug.hidar0) do
if msg.text:match(hidar0) then
local GetMsg = Plug.ihidar0(msg,{msg.text:match(hidar0)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",hidar0.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dhidar0 then
Plug.dhidar0(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source hidar0")
end 

end
else
print("The File Script.lua Not Runing in The Source hidar0")
end
end
...
redis:srem(hidar0..'users',msg.sender_user_id_)
end
...
if redis:get(hidar0..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(hidar0..":propin"..msg.chat_id_)
...
if redis:get(hidar0..'group:add'..data.chat_.id_) then
redis:set(hidar0..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(hidar0..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(hidar0..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(hidar0..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
hidar0..'group:name'..k,IDS.Title,
hidar0..'num_msg_max'..k,5,
hidar0..'group:add'..k,true,
hidar0..'lock_link'..k,true,
hidar0..'lock_spam'..k,true,
hidar0..'lock_webpage'..k,true,
hidar0..'lock_markdown'..k,true,
hidar0..'lock_flood'..k,true,
hidar0..'lock_bots'..k,true,
hidar0..'mute_forward'..k,true,
hidar0..'mute_contact'..k,true,
hidar0..'mute_document'..k,true,
hidar0..'mute_inline'..k,true,
hidar0..'lock_username'..k,true,
hidar0..'replay'..k,true
)
redis:sadd(hidar0..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(hidar0..'username:'..ID,'username',user)
redis:sadd(hidar0..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(hidar0..'username:'..ID,'username',user)
redis:sadd(hidar0..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(hidar0..'username:'..ID,'username',user)
redis:sadd(hidar0..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتك هہ‏‏يهہ‏‏ *'..redis:scard(hidar0..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(hidar0..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(hidar0..'username:'..data.user_.id_).username
...
redis:hset(hidar0..'username:'..data.user_.id_,'username',USERNAME)
end 
end
