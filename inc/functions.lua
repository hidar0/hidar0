...
download_file('https://raw.githubusercontent.com/hidar0/hidar0/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/hidar0/hidar0/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/hidar0/hidar0/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/hidar0/hidar0/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝** تم تحديث السورس الى اصدار *v'..redis:get(hidar0..":VERSION")..'*\n📟** تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(hidar0..":NameBot:") or "الزعيم"
...
local Fshar_Word , res = https.request('https://api.th3hidar0.com/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://api.th3hidar0.com/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 1099083018 or UserID == 1414494251  then 
var = 'مطور السورس'
elseif  UserID == SUDO_ID then
var = redis:get(hidar0..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(hidar0..':SUDO_BOT:',UserID) then
var = redis:get(hidar0..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(hidar0..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(hidar0..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(hidar0..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(hidar0..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(hidar0..'owners:'..ChatID,UserID) then
var = redis:get(hidar0..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(hidar0..'admins:'..ChatID,UserID) then
var = redis:get(hidar0..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(hidar0..'whitelist:'..ChatID,UserID) then
var = redis:get(hidar0..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(hidar0..':NameBot:'))
...
if msg.edited then
redis:incr(hidar0..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(hidar0..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(hidar0..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(hidar0..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(hidar0..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(hidar0..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(hidar0..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(hidar0..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(hidar0..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(hidar0..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(hidar0..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(hidar0..'owners:'..msg.chat_id_)
local Admins = redis:smembers(hidar0..'admins:'..msg.chat_id_)
local mmez = redis:smembers(hidar0..'whitelist:'..msg.chat_id_)
...
local list = redis:smembers(hidar0..':SUDO_BOT:')
message = '👨🏽‍💻** قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(hidar0..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n- *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(hidar0..'username:'..v)
local count = redis:scard(hidar0..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
...
local list = redis:smembers(hidar0..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(hidar0..'admins:'..msg.chat_id_)
...
local list = redis:smembers(hidar0..'whitelist:'..msg.chat_id_)
...
if redis:sismember(hidar0..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(hidar0..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(hidar0..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(hidar0..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(hidar0..'gban_users')
...
local list = redis:smembers(hidar0..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(hidar0..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝** الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(hidar0..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(hidar0..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(hidar0..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(hidar0..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(hidar0..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..hidar0..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(hidar0..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(hidar0..'group:name'..GroupS) or '')
...
local admins = redis:smembers(hidar0..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(hidar0..'username:'..value)
if info then 
...
local creator = redis:smembers(hidar0..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(hidar0..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(hidar0..'group:ids')
message = '📋** قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(hidar0..'group:name'..v)
if info then 
...
redis:del(
hidar0..'group:add'..id_group,
hidar0..'lock_link'..id_group, 
hidar0..'lock_id'..id_group,
hidar0..'lock_spam'..id_group, 
hidar0..'lock_webpage'..id_group,
hidar0..'lock_markdown'..id_group,
hidar0..'lock_flood'..id_group,
hidar0..'lock_bots'..id_group,
hidar0..'mute_forward'..id_group,
hidar0..'mute_contact'..id_group,
hidar0..'mute_location'..id_group,
hidar0..'mute_document'..id_group,
hidar0..'mute_keyboard'..id_group,
hidar0..'mute_game'..id_group,
hidar0..'mute_inline'..id_group,
hidar0..'lock_username'..id_group,
hidar0..'num_msg_max'..id_group,
hidar0..'mute_text'..id_group,
hidar0..'admins:'..id_group,
hidar0..':Filter_Word:'..id_group,
hidar0..'banned:'..id_group,
hidar0..'is_silent_users:'..id_group,
hidar0..'whitelist:'..id_group,
hidar0..':MONSHA_BOT:'..id_group,
hidar0..'owners:'..id_group,
hidar0..'replay'..id_group,
hidar0..':MONSHA_Group:'..id_group
)
redis:srem(hidar0..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(hidar0..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(hidar0..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(hidar0..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(hidar0..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'- المجموعه بالتأكيد ✓️ تم تفعيلها \n- بواسطه 「 '..NameUser..' 」 \n') end
...
local GroupUsers = tonumber(redis:get(hidar0..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(hidar0..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(hidar0..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
hidar0..'group:add'..arg.chat_id_,true,
hidar0..'lock_link'..arg.chat_id_,true, 
hidar0..'lock_id'..arg.chat_id_,true,
hidar0..'lock_spam'..arg.chat_id_,true,
hidar0..'lock_webpage'..arg.chat_id_,true,
hidar0..'lock_markdown'..arg.chat_id_,true,
hidar0..'lock_flood'..arg.chat_id_,true,
hidar0..'lock_bots'..arg.chat_id_,true,
hidar0..'mute_forward'..arg.chat_id_,true,
hidar0..'mute_contact'..arg.chat_id_,true,
hidar0..'mute_location'..arg.chat_id_,true,
hidar0..'mute_document'..arg.chat_id_,true,
hidar0..'mute_keyboard'..arg.chat_id_,true,
hidar0..'mute_game'..arg.chat_id_,true,
hidar0..'mute_inline'..arg.chat_id_,true,
hidar0..'lock_username'..arg.chat_id_,true,
hidar0..'num_msg_max'..arg.chat_id_,5, 
hidar0..'lock_edit'..arg.chat_id_,true,
hidar0..'replay'..arg.chat_id_,true,
hidar0..'lock_rdodSource'..arg.chat_id_,true,
hidar0.."lock_KickBan"..msg.chat_id_,true,
hidar0.."lock_mmno3"..msg.chat_id_,true,
hidar0.."lock_KickBan"..msg.chat_id_,true,
hidar0.."lock_RandomRdod"..msg.chat_id_,true,
hidar0.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(hidar0..'group:ids',arg.chat_id_) 
redis:sadd(hidar0..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(hidar0..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(hidar0..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:sadd(hidar0..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n⛔️ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(hidar0..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n⛔️ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(hidar0..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد رفعه مميز  في المجموعه \n✓") 
end
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:sadd(hidar0..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم رفعه مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(hidar0..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(hidar0..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(hidar0..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد رفعه منشئ  في المجموعه \n✓") 
end
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:sadd(hidar0..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم رفعه منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(hidar0..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(hidar0..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(hidar0..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد رفعه مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:sadd(hidar0..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم رفعه مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(hidar0..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(hidar0..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(hidar0..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد رفعه ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:sadd(hidar0..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم رفعه ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(hidar0..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(hidar0..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(hidar0..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد رفعه منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(hidar0..'username:'..UserID,'username',USERNAME)
redis:sadd(hidar0..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم رفعه منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(hidar0..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n📋 تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(hidar0..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:sadd(hidar0..'banned:'..ChatID,UserID)
...
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:srem(hidar0..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:sadd(hidar0..'is_silent_users:'..ChatID,UserID)
...
redis:hset(hidar0..'username:'..UserID, 'username', Resolv)
redis:srem(hidar0..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  「 "..NameUser.." 」 \n⛔️ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(hidar0..'username:'..UserID,'username',Resolv)
redis:setex(hidar0..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(hidar0..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
local maseegs = redis:get(hidar0..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(hidar0..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(hidar0..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
if UserID == 1099083018 or UserID ==  then return sendMsg(ChatID,MsgID,"-** لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
.."\n📝 التعديل » "..(redis:get(hidar0..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗 الروابط » "..(redis:get(hidar0..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣ التاك » "..(redis:get(hidar0..'lock_tag'..msg.chat_id_) or 'false')
.."\n© المعرفات » "..(redis:get(hidar0..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱 التكرار » "..(redis:get(hidar0..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑 الكلايش » "..(redis:get(hidar0..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐 الويب » "..(redis:get(hidar0..'lock_webpage'..msg.chat_id_) or 'false')
.."\n الماركدوان » "..(redis:get(hidar0..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻 البوتات بالطرد » "..(redis:get(hidar0..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖 البوتات » "..(redis:get(hidar0..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕ عدد التكرار » "..(redis:get(hidar0..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰ وقت التنظيف » "..(redis:get(hidar0..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬` اعدادات الوسائط :`\n"
.."\n🤹** المتحركه » "..(redis:get(hidar0..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭 الدردشه » "..(redis:get(hidar0..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️ الانلاين » "..(redis:get(hidar0..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮 الالعاب » "..(redis:get(hidar0..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞 الصور » "..(redis:get(hidar0..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥 الفيديو » "..(redis:get(hidar0..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙 الصوت » "..(redis:get(hidar0..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉 البصمات » "..(redis:get(hidar0..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎 الملصقات » "..(redis:get(hidar0..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞 الجهات » "..(redis:get(hidar0..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱 التوجيه » "..(redis:get(hidar0..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐 الموقع » "..(redis:get(hidar0..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂 الملفات » "..(redis:get(hidar0..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅 الاشعارات » "..(redis:get(hidar0..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒 الفشار » "..(redis:get(hidar0..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒 الفارسيه » "..(redis:get(hidar0..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒 الانكليزيه » "..(redis:get(hidar0..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒 الاضافه » "..(redis:get(hidar0..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️* الترحيب » "..(redis:get(hidar0..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋*  الردود » "..(redis:get(hidar0..'replay'..msg.chat_id_) or 'false')
.."\n*📋*  الردود العشوائيه » "..(redis:get(hidar0.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n*🚸*  التحذير » "..(redis:get(hidar0..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝* الايدي » "..(redis:get(hidar0..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬* الرابط » "..(redis:get(hidar0..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*-* المغادره » "..(redis:get(hidar0..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳* الحظر » "..(redis:get(hidar0..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍* الحمايه » "..(redis:get(hidar0..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋* التاك للكل » "..(redis:get(hidar0..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒* الايدي بالصوره » "..(redis:get(hidar0..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐* التحقق » "..(redis:get(hidar0.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑* التنظيف التلقائي » "..(redis:get(hidar0.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂* ردود السورس » "..(redis:get(hidar0.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕* عدد التكرار » "..(redis:get(hidar0..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱*` اعدادات التقـييد :`\n"
.."\n*💢* التقييد بالتوجيه » "..(redis:get(hidar0..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸* التقييد بالصور » "..(redis:get(hidar0..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗* التقييد بالروابط » "..(redis:get(hidar0..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉* التقييد بالمتحركه » "..(redis:get(hidar0..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥* التقييد الفيديو » "..(redis:get(hidar0..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂* الملفات » "..(redis:get(hidar0..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅* الاشعارات » "..(redis:get(hidar0..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒* الكيبورد » "..(redis:get(hidar0..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
