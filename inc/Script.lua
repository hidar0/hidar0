...
local inline = {{{text="قنآهہ‏‏ آلسـورس : Link 🍃",url="t.me/SouurceLink"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : Link](t.me/SouurceLink)',nil,inline,msg.id_)
return false
end
...
[Source Dev](https://t.me/IIIZIIII)
