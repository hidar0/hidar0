...
#      ███    ██▄ ███    ███          ███          ███ «Dev : @IIIZIIII
#      ███    ███ ███    ███    ▄█    ███    ▄█    ███
#    ▄█████████▀   ▀██████▀   ▄████████▀   ▄████████▀  «Source SouurceLink BY @SouurceLink
#---------------------------------------------------------------------
]]
...
if not msg.SudoUser then return '🛠*«* أنت لست المطور.  ⚙️'end
...
sendMsg(msg.chat_id_,msg.id_,'-«تم تعطيل المجموعه.  ⚠️\n-«بواسطه ⋙「 '..NameUser..' 」 \n')
end,{msg=msg})
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯«مـرحبآ آنآ بوت آسـمـي ]]..redis:get(hidar0..':NameBot:')..[[ 🎖
...
return '💱*«* تم وضـع شرط التفعيل اذا كانت المجموعه اكثر من.  *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'-*«* شرط التفعيل اذا كانت المجموعه اكثر من.  *【'..redis:get(hidar0..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end
...
echo '*------------------------------\n*- •⊱ { Location } ⊰•\n*»» '`curl http://SouurceLink.com/ip/location`'*'
echo '*------------------------------\n* •⊱ { Server[_]Login } ⊰•\n*»» '`whoami`'*'
echo '*------------------------------\n* •⊱ { Uptime } ⊰•  \n*»» '"$uptime"'*'
]]):read('*all')
end
...
text = [[💯«مـرحبآ آنآ بوت آسـمـي []]..redis:get(hidar0..':NameBot:')..[[] 🎖
💰«آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
-«مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
